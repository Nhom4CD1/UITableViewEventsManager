...
class EventLines
{
    ...
    private class func ngayThuHai() -> EventLines {
        ...
        events.append(Event(tenVieced: "Rửa mặt", noidungCVed: "Rửa mặt"))
        events.append(Event(tenVieced: "Ăn Sáng", noidungCVed: "Mua Hủ tiếu về ăn sáng ^^"))
        events.append(Event(tenVieced: "Lên Trường", noidungCVed: "Đi học buổi sáng"))
        events.append(Event(tenVieced: "Học KTMT", noidungCVed: "Học KTMT"))
        events.append(Event(tenVieced: "Học CĐ2", noidungCVed: "Học CHuyên Đề 2"))
        events.append(Event(tenVieced: "Ăn Trưa", noidungCVed: "Nghỉ ngơi ăn trưa"))
        events.append(Event(tenVieced: "Ngủ Trưa", noidungCVed: "Ngủ trưa"))
        events.append(Event(tenVieced: "Học CĐ3", noidungCVed: "Học Chuyên ĐỀ 3"))
        events.append(Event(tenVieced: "Ăn Tối", noidungCVed: "Nấu bữa tối"))
        events.append(Event(tenVieced: "Học AV", noidungCVed: "Học Anh Văn"))
        
        return EventLines(dateOfWeek: "Thứ 2 Là ngày đầu tuần", includeEvents: events, dateImage: #imageLiteral(resourceName: "thuHai"))
    }
    ...
    private class func ngayChuNhat() -> EventLines {
        ...
        events.append(Event(tenVieced: "Rửa mặt", noidungCVed: "Đánh răng, rửa mặt"))
        events.append(Event(tenVieced: "Ăn điểm tâm sáng", noidungCVed: "Mua bánh mì ăn sáng @@"))
        events.append(Event(tenVieced: "Đọc tin tức", noidungCVed: "Đọc tin tức trên mạng"))
        events.append(Event(tenVieced: "Học CĐ1", noidungCVed: "Thực Hành iOS"))
        events.append(Event(tenVieced: "Học KTMT", noidungCVed: "Học Kiến Trúc Máy Tính"))
        events.append(Event(tenVieced: "Ăn Trưa", noidungCVed: "Nấu ăn buổi trưa"))
        events.append(Event(tenVieced: "Ngủ Trưa", noidungCVed: "Ngủ Trưa 1h-5h PM ^^"))
        events.append(Event(tenVieced: "Nấu bữa tối", noidungCVed: "Nấu ăn buổi tối"))
        events.append(Event(tenVieced: "Đi xem phim", noidungCVed: "Đi xem phim với Gấu"))
        events.append(Event(tenVieced: "Ngủ", noidungCVed: "Đi ngủ sớm"))
